...
const mockApiKeyService = ApiKeyService as jest.MockedClass<
  typeof ApiKeyService
>;
const mockUsageService = UsageTrackingService as jest.MockedClass<
  typeof UsageTrackingService
>;
  ...
  describe("API Key Management", () => {
    ...
    describe("GET /api/v1/keys/:id", () => {
      it("should return API key by ID", async () => {
        ...
        mockApiKeyService.prototype.getApiKeyById.mockResolvedValue(
          mockApiKey as any,
        );
        ...
        expect(mockApiKeyService.prototype.getApiKeyById).toHaveBeenCalledWith(
          "key-123",
        );
      });
      ...
      it("should return 404 for non-existent key", async () => {
        ...
        await request(app).get("/api/v1/keys/nonexistent").expect(404);
      });
    });
  });
    ...
    describe("GET /api/v1/analytics", () => {
      it("should return usage analytics", async () => {
        const mockAnalytics = {
          ...
          hourlyStats: [{ hour: "2024-01-01 10:00:00", requests: 50 }],
          statusDistribution: { "200": 950, "404": 30, "500": 20 },
          tierDistribution: { FREE: 600, PRO: 300, ENTERPRISE: 100 },
        };

        mockUsageService.prototype.getAnalytics = jest
          .fn()
    ...
    describe("GET /api/v1/keys/:id/usage", () => {
      it("should return API key usage", async () => {
        const mockUsage = {
          ...
          dailyUsage: [{ date: "2024-01-01", requests: 20 }],
        };
        ...
        expect(mockUsageService.prototype.getApiKeyUsage).toHaveBeenCalledWith(
          "key-123",
        );
      });
    });
  ...
  describe("Authentication & Authorization", () => {
    describe("API Key Validation", () => {
      it("should allow requests with valid API key", async () => {
        ...
        expect(mockApiKeyService.prototype.validateApiKey).toHaveBeenCalledWith(
          "valid-api-key",
        );
      });
