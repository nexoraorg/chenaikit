...
describe("StellarConnector", () => {
  ...
  describe("getAccount", () => {
    it("should throw error as not implemented", async () => {
      await expect(
        connector.getAccount("G1234567890123456789012345678901234567890"),
  ...
  describe("submitTransaction", () => {
    it("should throw error as not implemented", async () => {
      ...
      await expect(
        connector.submitTransaction(mockTransaction),
      ).rejects.toThrow("Not implemented yet - see issue #24");
    });
  });
  ...
  describe("getFee", () => {
    it("should throw error as not implemented", async () => {
      await expect(connector.getFee()).rejects.toThrow(
        "Not implemented yet - see issue #24",
      );
    });
  });
  ...
  describe("getNetworkPassphrase", () => {
    it("should throw error as not implemented", async () => {
      await expect(connector.getNetworkPassphrase()).rejects.toThrow(
        "Not implemented yet - see issue #24",
      );
    });
  });
