  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: 800, mx: "auto" }}>
        ...
        >
          These Terms of Service govern your use of ChenaiKit. By accessing or
          using our platform, you agree to be bound by these terms. Full terms
          documentation will be published here prior to production launch.
        </Typography>
      </Box>
    </Box>
  );
    ...
    >
      <Box sx={{ maxWidth: 800, mx: "auto" }}>
        ...
        <Typography
          ...
          sx={{ color: "text.secondary", lineHeight: 1.8 }}
        >
          Your privacy is important to us. ChenaiKit collects only the data
          necessary to provide our services and never sells personal information
          to third parties. Full privacy policy documentation will be published
    ...
    <div className="App">
      ...
      >
        ...
        <Typography
          variant="h6"
          component="p"
          sx={{ opacity: 0.9, mb: 3, fontWeight: 400 }}
        >
      ...
      >
        <Suspense
          fallback={
            <LoadingSpinner fullScreen message="Loading dashboard content" />
          }
        >
          {DEMO_TABS.map((tab, index) => (
            <Box
      ...
      <Suspense fallback={<LoadingSpinner fullScreen message="Loading page" />}>
        <Routes>
          ...
          <Route
            path="/signup"
            element={
              <ErrorBoundary name="Signup page">
                <Signup />
              </ErrorBoundary>
            }
          />
          <Route
            ...
            element={
              <ErrorBoundary name="Password reset page">
                <ForgotPasswordPage />
              </ErrorBoundary>
            }
          />
                    ...
                    onUpdateNotificationPreferences={async (data) => {
                      await runSettingsRequest(
                        () =>
                          requestSettingsApi({
                            method: "put",
                            url: "/api/v2/account/notifications",
                            data,
                          }),
                    ...
                    onEnableTwoFactor={async () => {
                      await runSettingsRequest(
                        () =>
                          requestSettingsApi({
                            method: "post",
                            url: "/api/v2/account/two-factor/enable",
                          }),
                    ...
                    onDisableTwoFactor={async () => {
                      await runSettingsRequest(
                        () =>
                          requestSettingsApi({
                            method: "post",
                            url: "/api/v2/account/two-factor/disable",
                          }),
                    ...
                    onDeleteApiKey={async (id) => {
                      await runSettingsRequest(
                        () =>
                          requestSettingsApi({
                            method: "delete",
                            url: `/api/v2/account/api-keys/${id}`,
                          }),
                        "API key deleted.",
                      );
                    }}
                    onRegenerateApiKey={async (id) => {
                      const response = await runSettingsRequest(
                        () =>
                          requestSettingsApi({
                            method: "put",
                            url: `/api/v2/account/api-keys/${id}/regenerate`,
                          }),
                        "API key regenerated.",
                      );
                      const key = extractApiKey(response);
                      if (!key) {
                        throw new Error(
                          "The server did not return a regenerated API key.",
                        );
                      }
                      return { key };
                    }}
          ...
          <ErrorProvider>
            <PerformanceProvider>
              <ErrorBoundary
                ...
                fallbackTitle="ChenaiKit could not render"
              >
                <AuthProvider>
                  <AppRoutes />
                  <ToastContainer />
