...
describe("CreditScoreCard", () => {
  ...
  describe("Loading State", () => {
    it("renders loading spinner when loading is true", () => {
      renderWithTheme(
        <CreditScoreCard score={75} lastUpdated={mockDate} loading={true} />,
      );
  ...
  describe("Score Display", () => {
    it("renders credit score correctly", () => {
      renderWithTheme(<CreditScoreCard score={75} lastUpdated={mockDate} />);
    ...
    it('displays "Poor" rating for score 0-39', () => {
      renderWithTheme(<CreditScoreCard score={35} lastUpdated={mockDate} />);

      expect(screen.getByText("Poor")).toBeInTheDocument();
    });

    it('displays "Fair" rating for score 40-69', () => {
      renderWithTheme(<CreditScoreCard score={55} lastUpdated={mockDate} />);
    ...
    it('displays "Excellent" rating for score 85-100', () => {
      renderWithTheme(<CreditScoreCard score={90} lastUpdated={mockDate} />);
  ...
  describe("Accessibility", () => {
    it("has proper ARIA label", () => {
      const { container } = renderWithTheme(
        <CreditScoreCard score={75} lastUpdated={mockDate} />,
      );
  ...
  describe("Edge Cases", () => {
    it("handles score of 0 correctly", () => {
      renderWithTheme(<CreditScoreCard score={0} lastUpdated={mockDate} />);
    ...
    it("handles score of 100 correctly", () => {
      renderWithTheme(<CreditScoreCard score={100} lastUpdated={mockDate} />);
