...
const generateMockRiskFactors = (score: number): RiskFactor[] => {
  ...
  if (score >= 85) {
    factors.push(
      ...
      {
        id: "3",
        description: "Account age over 2 years shows stability",
        impact: "positive",
        severity: "medium",
      },
    );
    ...
    factors.push(
      {
        id: "1",
        description: "Good payment history with occasional delays",
        impact: "positive",
        severity: "medium",
      },
      {
    ...
    factors.push(
      {
        id: "1",
        description: "Inconsistent payment patterns detected",
        impact: "negative",
        severity: "medium",
      },
      {
        id: "2",
        description: "Low account balance relative to transaction size",
        impact: "negative",
        severity: "medium",
      },
      {
        id: "3",
        description: "Limited transaction history available",
        impact: "negative",
        severity: "low",
      },
    );
    ...
    factors.push(
      ...
      {
        id: "2",
        description: "High number of transactions with insufficient funds",
        impact: "negative",
        severity: "high",
      },
      {
        id: "3",
        description: "Account recently created with minimal history",
        impact: "negative",
        severity: "medium",
      },
      {
