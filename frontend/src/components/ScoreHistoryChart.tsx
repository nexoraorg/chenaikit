  ...
  if (data.length === 0) {
    return (
      <Card sx={{ height }}>
        <CardContent>
          <Alert severity="info">
            No score history available. Check back later for your credit score
            trends.
          </Alert>
        </CardContent>
      </Card>
  ...
  return (
    ...
    >
      <CardContent sx={{ p: 3, height: "100%" }}>
        ...
        <Box sx={{ mb: 2 }}>
          ...
          >
            {[
              {
                label: "Current",
                value: scoreStats.current,
                color: getScoreRating(scoreStats.current).color,
              },
              {
                label: "Average",
                value: scoreStats.avg,
        ...
        {/* Chart */}
        <Box
          sx={{ width: "100%", height: "calc(100% - 120px)", minHeight: 200 }}
        >
