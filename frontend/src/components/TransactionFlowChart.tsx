    ...
    const link = g
      ...
      .on("mouseover", (event, d) => {
        const tooltipContent = generateTooltipContent([
          {
            label: "Amount",
            value: formatCurrency(d.amount, d.asset),
            color: "#3B82F6",
          },
  ...
  return (
    ...
    >
      <svg
        ...
        id={id}
        aria-label={
          ariaLabel || getAriaLabel(processedData.nodes, "Transaction Flow")
        }
        aria-describedby={ariaDescribedby}
        style={{ display: "block" }}
      >
