...
import { ValidationRules, FormFieldConfig } from "@chenaikit/core";
...
const formConfigs: FormFieldConfig[] = [
  ...
  },
  {
    ...
    validation: ValidationRules.maxLength(
      100,
      "Memo must be less than 100 characters",
    ),
  },
];

// Example async validation for checking if Stellar address exists
const validateStellarAddressExists = async (
  address: string,
): Promise<string | null> => {
  ...
  try {
    ...
    if (
      address ===
      "GINVALID123456789012345678901234567890123456789012345678901234567890"
    ) {
...
export const FormValidationExample: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p>
        This example demonstrates real-time validation, debouncing, and
